					 ...
					 ?>
									...
									<form action="buscarPacienteQuirofano.php?codi=0&dni=0&nyap=0" method="POST" enctype="multipart/form-data" id="carga" name="carga" >	
												<br />	<div style="size:auto"><p style="font-size:18px; color:#003300; position:relative; left:-100px;">DNI DEL PACIENTE: &nbsp;&nbsp;<input  type="text" maxlength="8" name="dni" id='dni' size="10"  style="border:groove; text-align:center"><BR/> 
													...
													<div style="margin-left:18%">	<input onClick="validarPacienteQuirofano(this.form)" type="button" value="BUSCAR" name="BUSCAR" >&nbsp;&nbsp;<input onClick="location.href = 'ingresar.php' " type="button" value="CANCELAR" name="CANCELAR" ></div>		
										</form><br />
									<div style=" position:relative; left:400px; top:50px; font-size:24px">	
											
										<span style=" position: relative; top:150px;  right:-50px" ><p style="color:#FF0000"><span><?php echo $_SESSION["usuario"] ?></span><div style="position:relative; top:-36px; right:-110px" >&nbsp;&nbsp; &nbsp;<a href="cerrarsesion.php"><p style="color:#0000CC">[ CERRAR SESION ]</p></span></p></a>  </span>								
									   </div>
						...
						<?php
								...
								if( $valor == 1){
									...
									if(mysql_num_rows($respuesta) != 0){
										...
										$inserPa="insert into paciente(dni, nyap) value('$dni','$nyap')";
