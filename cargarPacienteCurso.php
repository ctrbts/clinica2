...
/////////////////////////////////////////////////////////////////////////////
	...
	if (!isset($_SESSION['pass'])){  	
					...
					//mysql_query("BEGIN WORK");
						...
						$sql = "SELECT * FROM pacienteCurso WHERE  dni=$dni";
						...
						if (( mysql_num_rows($result) == 0) && ($codi == 0)) 
						{
							...
							mysql_query("COMMIT");
							desconectar();
							$url_relativa = "pacienteCurso.php?valor=1&dni=$dni";
							desconectar();
						...
						{   
							...
							if($codi == 0){
									...
									$url_relativa = "pacienteCurso.php?valor=2&dni=$dni";
							 	...
							 	if($_GET['codi'] == 2){
									...
									echo $nyap;*/
											...
											//obtengo la fecha
									$consulta2="INSERT INTO pacientecurso(dni, nyap) VALUES ('$dni','$nyap')";
									$sqlpac=mysql_query($consulta2);
									$url='verinfopacientecurso.php?valor=0';
									redirigir($url);
								}
						}    
