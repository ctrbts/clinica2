	   ...
	   ?>
			 ...
			 <div> <img src="imagenes/banner.jpg" style="width:850px; height:100px; position:relative; left:-200px;" /> </div>
					...
					<div >
						<br />
						<div >
							<a href="bonoContribucion.php?valor=0"><p style="font-size:25px; color:#003300">BONO CONTRIBUCION</p></a>
						</div>
						<div >
							<a href="anularBonoEsterilizacion.php?valor=0"><p style="font-size:25px; color:#003300">Anular Bono de Esterilización</p></a>
						</div>
						<div >
						...
						<div >
							<a href="consultarEsterilizacion.php?valor=0"><p style="font-size:25px; color:#003300">Listar Rendicion de Esterilizacion</p></a>
							
						</div>						
							<a href="reimprimirBonoEsterilizacion.php?valor=0"><p style="font-size:25px; color:#003300">Reimprimir Bono Esterilizacion</p></a>
						</div>	
		   				<div>	
