...
<?php if (!isset($_SESSION['pass'])){ 
			...
			//busco el bono a imprimir
				$consu="SELECT * FROM bonoCurso WHERE idBono = $bono ";
			...
			//creacion de la fecha
				  ...
				  //consulta para obtener el precio del bono
					$sqlcurso="select * from curso where idCurso='$idCurso'";
		...
		$pdf->ezText( "<b>PACIENTE DEL CURSO: </b>" .$nyap. "<b> DNI: </b>".$dni ,18,array('justification'=>'left'));
		//agregar dni
	    $dni=$filaBono['dni'];
