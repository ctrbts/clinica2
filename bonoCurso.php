			 ...
			 <div> <img src="imagenes/banner.jpg" style="width:850px; height:100px; position:relative; left:-200px;" /> </div>
						<div style=" position:relative; left:950px; top:-110px; width:100px; right:-150px"><img src="imagenes/UNLP_Logo.jpg" alt="logo unlp" /> </div>
				         <div style="position:relative; left:200px; right:-550px; top:-200px" ><fieldset style=" width:600px; heigh:200px; border-top-width: 10px;  border-right-width: 1em;  border-bottom-width: thick;  border-left-width: thin; color:#00CC33">
						  <legend align="center" style="font-size:30px; color:#006600">OPCIONES del CURSO</legend>	  
					<div >
						<br />
						<div >
							<a href="bonoPacienteCurso.php?valor=0"><p style="font-size:25px; color:#003300">BONO CURSO</p></a>
						</div>
						<div >
							<a href="anularBonoCurso.php?valor=0"><p style="font-size:25px; color:#003300">Anular Bono Curso</p></a>
						</div>
						<div >
						<!--	<a href="cambiarNumeroEsterilizacion.php?valor=0"><p style="font-size:25px; color:#003300">Cambiar Codigo de Esterilizacion</p></a>-->
							
						</div>
						<div >
							<a href="consultaCurso.php?valor=0"><p style="font-size:25px; color:#003300">Listar Rendicion de Los Bonos del curso</p></a>
							
						</div>						
							<a href="reimprimirBonoCurso.php?valor=0"><p style="font-size:25px; color:#003300">Reimprimir Bono Curso</p></a>
						</div>	
		   				<div>	
