	...
	<div id="marco">
					...
					<?php if($valor == 0){ ?>
						...
						<br/>
							...
							<fieldset style=" position:relative; width:60%; height:auto; left:auto "><legend><B>LISTADO DE BONOS DE LOS CURSOS EMITIDOS</B></legend>							
									<form action="listarBonosCursos.php" target="_blank" method="POST" enctype="multipart/form-data">
									<div id="fechas1">
					...
					<!--	<fieldset style=" position:relative; width:60%; height:auto; left:auto "><legend><B>LISTADO DE BONOS DE ESTERILIZACION ENTRE DOS FECHAS</B></legend>							
						...
						<fieldset style=" position:relative; width:60%; height:auto; left:auto "><legend><B>LISTADO DE BONOS DE ESTERILIZACION PARA RENDICION</B></legend>							
									<form action="listarRendicionCurso.php" target="_blank" method="POST" enctype="multipart/form-data">
									<div id="fechas1">
				...
				<?php	}
							...
							if( $valor=1 ){	 ?><div><b style="color:#FF0000">INGRESE LA FECHA , POR FAVOR VERIFICAR ANTES DE PRESIONAR </b> </div>	
								<fieldset style=" position:relative; width:60%; height:auto; left:auto "><legend><B>LISTADO DE BONOS DE ESTERILIZACION EMITIDOS</B></legend>							
									<form action="listarBonosEsterilizacion.php" target="_blank" method="POST" enctype="multipart/form-data">
									<div id="fechas1">
													<b style="color:#0000FF">FECHA</b><input text="text" name="fechaBono" id="datepicker5"/>
															<img src="IMAGENES/separadorFecha.jpg" />
															<input type="submit" value="LISTAR" id="botBuscar"> 
							...
							<fieldset style=" position:relative; width:60%; height:auto; left:auto "><legend><B>LISTADO DE BONOS DE ESTERILIZACION </B></legend>							
									<form action="listarBonosEsterilizacionEmitidos.php" target="_blank" method="POST" enctype="multipart/form-data">
									<div id="fechas1">
						...
						<fieldset style=" position:relative; width:60%; height:auto; left:auto "><legend><B>LISTADO DE BONOS DE ESTERILIZACION PARA RENDICION</B></legend>							
									<form action="listarRendicionEsterilizacion.php" target="_blank" method="POST" enctype="multipart/form-data">
									<div id="fechas1">
