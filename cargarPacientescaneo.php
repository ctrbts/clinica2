...
/////////////////////////////////////////////////////////////////////////////
	...
	if (!isset($_SESSION['pass'])){  	
					...
					//mysql_query("BEGIN WORK");
						...
						$sql = "SELECT * FROM pacientescaneo WHERE  dni=$dni";
						...
						if (( mysql_num_rows($result) == 0) && ($codi == 0)) 
						{
							...
							mysql_query("COMMIT");
							desconectar($db);
							$url_relativa = "pacientescaneo.php?valor=1&dni=$dni";
							//desconectar();
						...
						{   
							...
							if($codi == 0){
											//aca vamos a  paciente del escaneo, ya que el paciente ya existe
									$url_relativa = "pacientescaneo.php?valor=2&dni=$dni";
							 	...
							 	if($_GET['codi'] == 2){
									...
									echo $nyap;*/
											...
											//obtengo la fecha
									$consulta2="INSERT INTO pacientescaneo(dni, nyap) VALUES ('$dni','$nyap')";
									$sqlpac=mysql_query($consulta2);
									$url='verinfopacientescaneo.php?valor=0';
									redirigir($url);
								}
							//echo 'paso';	
						}    
