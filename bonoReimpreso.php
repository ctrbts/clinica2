  ...
  if (!isset($_SESSION['pass'])){  
		 ...
		 $db = conectar_admin();
		  ...
		  ?> <p style=" font-size:30px; color:#FF0000" > <?php   
		  		echo 'Nombre y apellido: ';  echo   $fila['paciente']; ?>
				<br/>
				<?php
		...
		?> </fieldset >
		 ...
		 desconectar();
		  ...
		  if ($cancelado = 1){  
		  		?><p style="font-size:18px; color:#000099"> <?php echo 'Nombre y apellido: ';  echo $fila['paciente']; ?>
				<br/>
		  ...
		  ?></p> <p style=" font-size:30px; color:#FF0000" >
						<div >
							<a href="reimpresionbonoPdf.php?bono=<?php echo $bono ?>" target="_blank"><p style="font-size:25px; color:#003300">Reimprimir Bono </p></a>
						</div>
						<?php 
