	...
	if (!isset($_SESSION['pass'])){  	
					...
					//mysql_query("BEGIN WORK");
						...
						if ( mysql_num_rows($result) == 0) 
						{
							...
							mysql_query("COMMIT");
							desconectar();
							$url_relativa = "modificacionPaciente.php?valor=1";
						...
						{   
							if($_GET['codi'] == 1){
									...
									$_SESSION['dni']=$dni;	
									$url_relativa = "modificacionPaciente.php?valor=2";
									...
									$sql2="UPDATE paciente SET apellido='$apellido', nombre='$nombre', direccion='$direccion', localidad='$localidad' WHERE dni='$dni'";
									$result=mysql_query($sql2);
									$url_relativa = "modificacionPaciente.php?valor=0";
									redirigir($url_relativa);
								}
					}	
