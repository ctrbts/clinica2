...
if (!isset($_SESSION['pass'])) {  ?>
			...
			<?php	
					if ( $valor == 0 ) {  ?>
									...
									<form action="borrarPaciente.php?codi=1" method="POST" enctype="multipart/form-data" id="modificacion" name="modificacion" >	
						...
						<?php
										 ...
										 <?php } 
												 ...
												 ?>
													<form action="borrarPaciente.php?codi=2" method="POST" enctype="multipart/form-data"  >	
															...
															<div style="margin-left:28%">	<input onClick="validarAltaPaciente(this.form)" type="button" value="borrar" name="borrar" ></div>		
													<?php 
													//desconectamos la BD
													desconectar();	?>		
													</form>
