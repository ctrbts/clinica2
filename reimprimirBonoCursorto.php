	...
	<body >
	   ...
	   <?php if (!isset($_SESSION['pass'])){ 
		 ...
		 ?>
			 ...
			 <div> <img src="imagenes/banner.jpg" style="width:750px; height:100px; position:relative; left:-250px" /> </div> 								<span position: relative; right:-50px ><p style="color:#FF0000"><span><?php echo $_SESSION["usuario"] ?></span><div style="position:relative; top:-36px; right:-110px" >&nbsp;&nbsp; &nbsp;<a href="cerrarsesion.php"><p style="color:#0000CC">[ CERRAR SESION ]</p></span></p></a>  </span>	
						<div style="position:relative; left:1050px; top:-120px; width:100px; heigh:100px; right:150px"><img src="imagenes/UNLP_Logo.jpg" alt="logo unlp" /></div>
				         <div style="position:relative; left:30px; right:30px; top:-220px; " ><fieldset style=" width:950px; heigh:200px; border-top-width: 10px;  border-right-width: 1em;  border-bottom-width: thick;  border-left-width: thin; color:#00CC33;">
						  <legend align="center" style="font-size:24px"><B style="left:100px; color:#258DF5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;REIMPRIMIR BONO CURSO</B></legend>	  
					<div > 
						
					
									
									<form action="bonoCursortoReimpreso.php?valor=0" method="POST" enctype="multipart/form-data" id="bonus" name="bonus" >	
												<br />	<div style="size:auto"><p style="font-size:18px; color:#003300; position:relative; left:-100px;"># BONO: &nbsp;&nbsp;<input  type="text" maxlength="8" name="bono" id='bono' size="8"  style="border:groove; text-align:center"><BR/>  
												 <div style="margin-left:18%">	<input  type="submit" value="BUSCAR" name="BUSCAR" >&nbsp;&nbsp;<input onClick="location.href = 'bonoCursorto.php' " type="button" value="CANCELAR" name="CANCELAR" ></div>		
										</form><br />
			 ...
			 <div> <img src="imagenes/banner.jpg" style="width:750px; height:100px; position:relative; left:-250px" /> </div> 								<span position: relative; right:-50px ><p style="color:#FF0000"><span><?php echo $_SESSION["usuario"] ?></span><div style="position:relative; top:-36px; right:-110px" >&nbsp;&nbsp; &nbsp;<a href="cerrarsesion.php"><p style="color:#0000CC">[ CERRAR SESION ]</p></span></p></a>  </span>	
						<div style="position:relative; left:1050px; top:-120px; width:100px; heigh:100px; right:150px"><img src="imagenes/UNLP_Logo.jpg" alt="logo unlp" /></div>
				         <div style="position:relative; left:30px; right:30px; top:-220px; " ><fieldset style=" width:950px; background-color:#D2F525; heigh:200px; border-top-width: 10px;  border-right-width: 1em;  border-bottom-width: thick;  border-left-width: thin; color:#00CC33;">
						  <legend align="center" style="font-size:40px; "><B style="left:100px; color:#ff8DF5 ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;REIMPRIMIR BONO DEL CURSO DE ORTODONCIA</B></legend>	  
					<div > 
						
					
									
									<form action="bonoCursortoReimpreso.php?valor=1" method="POST" enctype="multipart/form-data" id="bonus" name="bonus" >	
												<br />	<div style="size:auto"><p style="font-size:18px; color:#003300; position:relative; left:-100px;"># BONO: &nbsp;&nbsp;<input  type="text" maxlength="8" name="bono" id='bono' size="8"  style="border:groove; text-align:center"><BR/>  
												 <div style="margin-left:18%">	<input onClick="validarBonoAnulado(this.form)" type="button" value="BUSCAR" name="BUSCAR" >&nbsp;&nbsp;<input onClick="location.href = 'ingresar.php' " type="button" value="CANCELAR" name="CANCELAR" ></div>		
										</form><br />
									<div style=" position:relative; left:400px; top:50px; font-size:24px">	
